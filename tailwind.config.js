  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        injection: "url('./assets/images/injection.svg')",
        wound: "url('./assets/images/wound.svg')",
        catherization: "url('./assets/images/catherization.svg')",
        healthcare: "url('./assets/images/healthcare.svg')",
        creativity: "url('./assets/images/creativity.svg')",
        empathy: "url('./assets/images/empathy.svg')",
        integrity: "url('./assets/images/integrity.svg')",

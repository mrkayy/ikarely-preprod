    ...
    return (
        <div className='footer'>
            ...
            <div className="footer__right">
                ...
                <ul>
                    <li>
                    <a href= "tel:+2348035418437">08035418437,</a> <a href= "tel:+2349063870220"> 09063870220</a> 
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        1-5 Oba Akinjobi Way, GRA, Ikaja, Lagos, Nigeria.
                    </li>
                </ul>
            </div>
                    </div>
                ...
                <ul>
                    <li>
                    <a href= "https://twitter.com/ikarelylimited?s=21">Twitter</a> <a href= "tel:+2349063870220"></a> 
                    </li>
                    <li>
                      <a href= "https://instagram.com/ikarelylimited?igshid=1cnrk25ti9ngl">Instagram</a>
                    </li>
                </ul>
            </div>
                    </div>
